                            ...
                            Column {
                                ...
                                Canvas {
                                    ...
                                    onPaint: {
                                        ...
                                        var scaleX = (maxLng - minLng) === 0 ? 1 : width  / (maxLng - minLng)
                                        var scaleY = (maxLat - minLat) === 0 ? 1 : height / (maxLat - minLat)

                                        for (var i = 0; i < points.length; ++i) {
                                            var p = points[i]
                                            var x = (p[1] - minLng) * scaleX
                                            var y = height - (p[0] - minLat) * scaleY
                                            if (i === 0)
                                                ctx.moveTo(x, y)
                                            else
                                                ctx.lineTo(x, y)
